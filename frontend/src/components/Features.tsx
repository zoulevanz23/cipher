      ...
      {groups.map((group) => (
        <div key={group}>
          <div className="flex items-center gap-3 mb-5">
            <span className="text-xs font-mono text-accent uppercase tracking-wider">{group}</span>
            <div className="h-px flex-1 bg-border" />
            <span className="text-[10px] font-mono text-gray-600">
              {features.filter((f) => f.group === group).length} features
            </span>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {features
              ...
              .map((feature) => (
                <div
                  key={feature.title}
                  className="bg-surface-2/50 border border-border rounded-xl p-5 hover:bg-surface-2/80 hover:border-accent/20 transition-all group"
                >
